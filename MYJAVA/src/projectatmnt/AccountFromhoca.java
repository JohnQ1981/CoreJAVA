...
public class AccountFromhoca {
	...
	public void getDepositChecking() {
		System.out.println("Your saving account balance: " + moneyFormat.format(getCheckingBalance()));
	...
	public void getDepositSaving() {
		System.out.println("Your checking account balance: " + moneyFormat.format(getSavingBalance()));
		System.out.print("Please, enter the amount you want to deposit: ");
		double amount = scan.nextDouble();
		if (amount <= 0) {
			System.out.println("Amount cannot be less than or equal to 0");
