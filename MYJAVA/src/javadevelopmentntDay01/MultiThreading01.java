...
public class MultiThreading01 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Thread.sleep(5000);==> to make Java wait for printing the duration
		//of the execution we used sleep() but it is not good practice
		//Instead of using Sleep (), we can use join(); 

		counter3.join();// join method tells complete multi threading than continue 
		counter4.join();
...
// 1st step extend to Thread Class , 2nd step override the run() Method.
//3rd is after creating object using start();
