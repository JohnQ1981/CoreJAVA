...
public class MultiThreading01FromHoca {
...
class CoounterWithoutMultiThread{

	private int threadNum;

	public CoounterWithoutMultiThread(int threadNum) {
...
class CoounterWithMultiThread extends Thread{

	private int threadNum;

	public CoounterWithMultiThread(int threadNum) {
		this.threadNum = threadNum;
	}
