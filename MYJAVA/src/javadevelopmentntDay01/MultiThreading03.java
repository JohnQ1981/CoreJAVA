...
public class MultiThreading03 {
	...
	public static void main(String[] args) {
		...
		Thread thread1 = new Thread(new Runnable() {
			...
			public void run() {
				Counter.count();
				System.out.println("The task for thread1 is completed");
		...
		Thread thread2 = new Thread(new Runnable() {
			...
			public void run() {
				Counter.count();
				System.out.println("The task for thread2 is completed");
...
class Counter{
	/*
 	...
 	if you use a single data for different threads, you have to synchronize the method
 	otherwise you will get different outputs in every execution. 
